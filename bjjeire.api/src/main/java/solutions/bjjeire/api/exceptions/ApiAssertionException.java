...
public class ApiAssertionException extends AssertionError {
    ...
    public ApiAssertionException(String message, String requestPath, @Nullable String responseBody, Throwable cause) {
        super(buildAssertionMessage(message, requestPath, responseBody), cause);
        this.requestPath = requestPath;
        this.responseBody = responseBody;
    }

    private static String buildAssertionMessage(String message, String requestPath, @Nullable String responseBody) {
        return String.format(
                ...
                message,
                requestPath,
                responseBody != null ? responseBody : "[Empty or Null]");
    }
