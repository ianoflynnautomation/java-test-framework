...
public class ApiClient {
         ...
         * This acts as a non-intrusive interceptor, useful for debugging in a CI/CD
         * environment.
         *
        ...
        private ExchangeFilterFunction loggingFilter() {
                return (clientRequest, next) -> {
                        ...
                        clientRequest.headers().forEach((name, values) -> values
                                        .forEach(value -> log.debug("  -> Header: {}={}", name, value)));
                        return next.exchange(clientRequest)
                                        .doOnNext(response -> log.info("Response: Status {}",
