...
public class ApiRequestBuilder {
  ...
  public static class Builder {
    ...
    public Builder acceptableMediaTypes(List<MediaType> mediaTypes) {
      this.acceptableMediaTypes =
          mediaTypes != null ? mediaTypes : Collections.singletonList(MediaType.APPLICATION_JSON);
      return this;
    }
    ...
    public ApiRequestBuilder build() {
      if (method == null || path == null) {
        throw new IllegalStateException(
            "HTTP method and path must be set before building the request.");
      }
