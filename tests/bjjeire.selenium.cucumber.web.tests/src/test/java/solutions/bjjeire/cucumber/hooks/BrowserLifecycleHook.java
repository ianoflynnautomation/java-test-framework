...
public class BrowserLifecycleHook extends UsesPlugins {
  ...
  private final ThreadLocal<solutions.bjjeire.core.plugins.ScenarioContext> pluginEngineContext =
      new ThreadLocal<>();
  private static final ThreadLocal<Boolean> IS_CUCUMBER_CONFIGURED =
  ...
  public void beforeScenario(Scenario scenario) {
    ...
    solutions.bjjeire.core.plugins.ScenarioContext coreContext =
        new solutions.bjjeire.core.plugins.ScenarioContext(scenario.getName(), null, config);
  ...
  public void afterScenario(Scenario scenario) {
    solutions.bjjeire.core.plugins.ScenarioContext initialCoreContext =
        this.pluginEngineContext.get();
    if (initialCoreContext == null) {
      log.warn(
          "Plugin Engine Context was not initialized for scenario: {}. Skipping post-scenario hooks.",
          scenario.getName());
      return;
    }
    ...
    try {
      ...
      solutions.bjjeire.core.plugins.ScenarioContext finalCoreContext =
          new solutions.bjjeire.core.plugins.ScenarioContext(
              initialCoreContext.getScenarioName(),
              result,
              initialCoreContext.getBrowserConfiguration());
