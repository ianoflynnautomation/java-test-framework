...
public class BrowserConfiguration {
    ...
    public BrowserConfiguration(Browser browser, Lifecycle browserBehavior, Integer browserWidth,
    ...
    public boolean equals(Object obj) {
        ...
        if (!Objects.equals(this.getBrowser(), that.getBrowser()))
            return false;
        if (!Objects.equals(this.deviceName, that.deviceName))
            return false;
        if (!Objects.equals(this.getLifecycle(), that.getLifecycle()))
            return false;
        ...
        if (this.getVersion() != that.getVersion())
            return false;
        if (!Objects.equals(this.getPlatform(), that.getPlatform()))
            return false;
