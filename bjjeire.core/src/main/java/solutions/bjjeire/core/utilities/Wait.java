...
public class Wait {
  ...
  public static boolean retry(
    ...
    while (System.currentTimeMillis() < end) {
      try {
        ...
        shouldThrow =
            !(Arrays.stream(exceptionsToIgnore).anyMatch(exception -> exception.isInstance(exc)));
        if (shouldThrow) {
  ...
  public static boolean forConditionUntilTimeout(
      Comparator condition, long timeoutInMilliseconds, long pollingIntervalInMilliseconds) {
