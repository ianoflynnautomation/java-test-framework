...
public class NavigationService extends WebService {
  ...
  public void to(WebPage page) {
    ...
    log.info(
        "Navigating to page",
        StructuredArguments.keyValue("pageClass", page.getClass().getSimpleName()));
  ...
  public void toLocalPage(String filePath) {
    ...
    log.info(
        "Navigating to local page resource", StructuredArguments.keyValue("filePath", filePath));
    ...
    if (testAppUrl != null) {
      ...
      log.error(
          "Local page resource not found", StructuredArguments.keyValue("filePath", filePath));
  ...
  public void waitForPartialUrl(String partialUrl) {
    ...
    try {
      var webDriverWait =
          new WebDriverWait(
              getWrappedDriver(),
              Duration.ofSeconds(waitForPartialTimeout),
      ...
      log.error(
          "Timeout waiting for partial URL",
          StructuredArguments.keyValue("partialUrl", partialUrl),
